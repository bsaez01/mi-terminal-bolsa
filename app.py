...
# --- 1. CONFIGURACIÓN ---
# Tu URL de publicación directa y limpia
...
def leer_portafolio():
    try:
        # Conexión directa sin trucos de URL que causen errores de DNS
        ...
        if response.status_code == 200:
            ...
            # Limpieza de datos numéricos (8 decimales y comas latinas)
    ...
    if not df_p.empty and 'ticker' in df_p.columns:
        ...
        for t in df_p['ticker'].unique():
            ...
            if total > 1e-9:
                ...
                c_inf, c_btn = st.columns([2, 1]) # Proporción para que no de error
