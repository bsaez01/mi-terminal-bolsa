...
# --- 1. CONFIGURACIÓN ---
# Tu enlace de publicación que ya está verificado
...
def leer_portafolio():
    try:
        ...
        if response.status_code == 200:
            ...
            # Limpieza de números (Puntos y comas)
    ...
    if not df_p.empty and 'ticker' in df_p.columns:
        for t in df_p['ticker'].unique():
            ...
            if total > 1e-9:
                ...
                # Ajustamos columnas para evitar error de visualización
...
# --- 3. LÓGICA DE MERCADO (TODO INTEGRADO) ---
